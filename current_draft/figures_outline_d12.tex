...
\begin{flushleft}
	...
	\textcolor{red}{Imaging elastodynamic and hydraulic properties of in-situ fractured rock: An experimental investigation considering effects of dynamic stressing and shearing}}
\end{Large}
\end{flushleft}
%\pagebreak
...
\begin{figure*}[ht] 
	...
	\centering 
	\includegraphics[width=0.9 \columnwidth]{exp_config}
...
\begin{figure*}[ht]
	\centering
	\includegraphics[width=0.9\columnwidth]{exp_sequence2}
...
\paragraph{}
In subsequent sections we discuss how nonlinear elastodynamic and hydraulic parameters $\Delta c/c_0$, $dc/c_0$, $\dot c$, $ \Delta k/k_0 $, and $ \dot k $ vary with normal stress and pore pressure oscillation amplitudes and frequencies. We also discuss how these results are affected by shearing for both experiments p4966 and p4975. 
...
\begin{figure}[ht]
	...
	\caption{Run 3 of experiment p4975. Trying to figure out how to incorporate this into the main body, maybe move to supplemental.}
...
\begin{figure*}[h]
	...
	%	\includegraphics[width=0.7\columnwidth]{NSbowtie_p4975_run3b_01Hz_Cycle19}
	%	\includegraphics[width=0.99\columnwidth]{NS_bowtie_p4975_run3b_01Hz}
	\includegraphics[width=0.4\columnwidth]{bowtie_p4975_run3b_01Hz}
	\caption[]{}
	\label{fig:bowties}
\end{figure*}
