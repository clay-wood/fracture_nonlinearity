...
\begin{keypoints}
\item Laboratory experiments model field conditions to understand underlying physics of fractured subsurface
\item Active source monitoring reveals complex relationship between elastodynamic and hydraulic properties
\item Dynamic stressing of in-situ fracture results in transient softening, recovery, and permeability enhancement
\end{keypoints}
...
\bibliography{biblio_JGR_ClayWood}
